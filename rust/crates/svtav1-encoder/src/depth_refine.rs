...
mod tests {
    ...
    fn m5_gradient64_scan_matches_capture() {
        ...
        for (qp, qindex, lambda) in [(20u32, 80u8, 25650u64), (40, 160, 248207)] {
            ...
            let eval =
                crate::pd0::pd0_pick_sb_partition_m6_eval(&y, 64, 0, 0, qp, qindex, &tables, 8, 1, false, true, 64, 64, 0, 0, None);
        ...
        let eval = crate::pd0::pd0_pick_sb_partition_m6_eval(&y, 64, 0, 0, 55, 220, &tables, 8, 1, false, true, 64, 64, 0, 0, None);
        assert!(!eval.split);
    ...
    fn m4_gradient64_scan_shape() {
        ...
        let eval = crate::pd0::pd0_pick_sb_partition_m6_eval(&y, 64, 0, 0, 20, 80, &tables, 8, 1, false, true, 64, 64, 0, 0, None);
        assert!(eval.split);
