> Historical document from `rust/docs/ANIMATED-AVIF-PLAN.md` at SVT `0cbd1279`. Original text follows unchanged; current status is in [CONTEXT-HANDOFF.md](https://github.com/imazen/zenav1-svt/blob/main/CONTEXT-HANDOFF.md). Original relative links/line numbers retain their original context.
