//! Sweep cancellation requests across an encode and report ask-to-return latency.
//! Counts requests ignored by the encoder as well as honoured cancellations.
//!
//! Usage: cancel_latency --sizes 64,256,1024,4096 --preset 8 --points 12
//!        --reps 3 --baseline-reps 2 --out FILE
//! Scheduling niceness is recorded; compare runs on the same host and priority.
