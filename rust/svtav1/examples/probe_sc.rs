...
use svtav1_encoder::sc_detect::{derive_sc, is_screen_content_antialiasing_aware, ScArm};
...
fn main() {
    ...
    for fast in [false, true] {
        ...
        eprintln!(
            ...
            c.sc_class0 as u8, c.sc_class1 as u8, c.sc_class2 as u8,
            c.sc_class3 as u8, c.sc_class4 as u8, c.sc_class5 as u8
        );
    }
    for preset in -1..=13i8 {
        ...
        println!(
            ...
            d.classes.sc_class5 as u8, d.palette_level, d.intrabc_level,
            d.allow_intrabc as u8, d.allow_screen_content_tools as u8
        );
    }
}
