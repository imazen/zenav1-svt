...
PORTED = {
    ...
    "get_tx_size_context": "pipeline/entropy_ctx.rs::EntropyCtx::tx_size_ctx",
    "set_txfm_ctx": "pipeline/entropy_ctx.rs::EntropyCtx::record_txfm_dims",
    "set_txfm_ctxs": "pipeline/entropy_ctx.rs::EntropyCtx::record_txfm_dims",
    ...
    "code_tx_size": "pipeline/block_syntax.rs (the per-block wrapper)",
    ...
    "av1_encode_coeff_1d": "pipeline/block_syntax.rs + entropy/coeff_c.rs",
    "av1_encode_tx_coef_y": "pipeline/block_syntax.rs + entropy/coeff_c.rs",
    "av1_encode_tx_coef_uv": "pipeline/block_syntax.rs + entropy/coeff_c.rs",
    "ec_update_neighbors": "pipeline/entropy_ctx.rs::EntropyCtx update methods",
    "svt_aom_write_modes_sb": "pipeline/partition_walk.rs::encode_partition_tree",
    "write_modes_b": "pipeline/block_syntax.rs::encode_block_syntax (intra) + port_entropy_inter/block.rs::write_inter_mode_info (inter)",
    ...
    "write_cdef": "pipeline/block_syntax.rs::encode_block_syntax (inline)",
