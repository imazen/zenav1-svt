...
roots = [pathlib.Path('/home/lilith/tmp/svt-tracking/research-dims10-fixed/artifacts')]
rows = []
for root in roots:
...
pathlib.Path('/home/lilith/tmp/svt-tracking/research-dims10-independent-decode.json').write_text(json.dumps(rows, indent=2)+'\n')
