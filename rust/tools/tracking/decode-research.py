...
roots = [pathlib.Path('/home/lilith/tmp/svt-tracking/research-matrix/artifacts'), pathlib.Path('/home/lilith/tmp/svt-tracking/research-matrix10-fixed/artifacts')]
rows = []
for root in roots:
...
pathlib.Path('/home/lilith/tmp/svt-tracking/research-independent-decode.json').write_text(json.dumps(rows, indent=2)+'\n')
