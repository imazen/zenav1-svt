...
for scm,content,preset in [(0,'screen',6),(1,'gradient',6),(1,'gradient',8)]:
 ...
 env=dict(os.environ,SVTAV1_BD='10',SVTAV1_HBD_SRC='1',SVTAV1_SCM=str(scm),SVT_SCM=str(scm),SVT_TRACE_OUT='/dev/null',SVT_BUILD_JOBS='4')
 for name,cmd in [('rust',[str(root/'tools/identity_run'),content,'72','88','40',str(preset),str(p)]),('c',[str(root/'tools/capture_c_trace/capture_c_trace'),'72','88','40',str(preset),str(p)+'.yuv',str(p)+'.c.obu','10'])]:
